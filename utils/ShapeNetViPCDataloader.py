...
if __name__ == "__main__":
    ...
    category = "table"
    ShapeNetViPCDataset = ShapeNetViPCDataloader(r'TrainTest_List/ShapeNetViPC/train_list.txt',data_path='/root/autodl-tmp/ShapeNetViPC',status='test', category = category)
    train_loader = DataLoader(ShapeNetViPCDataset,
                              batch_size=1,
                              num_workers=1,
                              shuffle=True,
                              drop_last=True)
